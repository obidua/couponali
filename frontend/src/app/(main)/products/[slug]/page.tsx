          ...
          <div className="sticky top-24">
            <div className="relative aspect-square overflow-hidden rounded-lg border bg-muted">
              {product.image_url ? (
                ...
                <div className="flex h-full w-full items-center justify-center text-6xl font-bold text-primary/20">
                  {product.name.charAt(0)}
                </div>
              )}
              {product.is_bestseller && (
                <Badge className="absolute left-4 top-4 gap-1" variant="warning">
          ...
          <div className="mt-8">
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="validity">
                <AccordionTrigger>Validity</AccordionTrigger>
                <AccordionContent>
                  <div className="text-sm text-muted-foreground">
